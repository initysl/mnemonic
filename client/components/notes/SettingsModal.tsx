    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
              ...
              <div className='mt-5 flex items-center justify-between gap-4'>
                ...
                <div className='flex items-center gap-2'>
                  <button
                    ...
                    className='rounded-full border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-700 shadow-sm hover:border-neutral-300 hover:bg-neutral-50 transition disabled:opacity-60'
      ...
      {confirmOpen && (
        <div className='absolute inset-0 z-10 flex items-center justify-center'>
          ...
          />
          <div className='relative w-full max-w-xs rounded-2xl border border-neutral-200 bg-white p-5 shadow-[0_20px_40px_rgba(15,23,42,0.2)]'>
            ...
            <div className='mt-4 flex items-center justify-end gap-2'>
              <button
                onClick={() => setConfirmOpen(false)}
                className='rounded-full border border-neutral-200 px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition'
                disabled={deleteAllNotes.isPending}
              >
                Cancel
              </button>
              <button
                ...
                className='rounded-full bg-red-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 transition disabled:opacity-60'
                disabled={deleteAllNotes.isPending}
              >
